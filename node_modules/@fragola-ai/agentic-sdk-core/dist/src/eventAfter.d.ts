 ...
 */
export type EventAfterConversationUpdate<TMetaData extends DefineMetaData<any>, TGlobalStore extends StoreLike<any>, TStore extends StoreLike<any>> = (reason: conversationUpdateReason, context: AgentContext<TMetaData, TGlobalStore, TStore>) => maybePromise<void>;
...
export type callbackMap<TMetaData extends DefineMetaData<any>, TGlobalStore extends StoreLike<any>, TStore extends StoreLike<any>> = {
    [K in AgentAfterEventId]: K extends "after:conversationUpdate" ? EventAfterConversationUpdate<TMetaData, TGlobalStore, TStore> : K extends "after:stateUpdate" ? AfterStateUpdateCallback<TMetaData, TGlobalStore, TStore> : never;
};
